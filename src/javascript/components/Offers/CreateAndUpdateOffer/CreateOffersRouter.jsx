...
class CreateOffers2Router extends PureComponent {
        ...
        return(
            <Switch>
                ...
                <RegularRoute
                    ...
                    loggedIn
                    path={ '/private/sessions/session/:id/offers/new-offer/:offerId/generated-offers/:offerDetailsId/details' }
                />
                <RegularRoute
                    render={(props) => {
                    ...
                    loggedIn
                    path={ '/private/sessions/session/:id/offers/new-offer/:offerId/generated-offers' }
                />
                <RegularRoute
                    render={(props) => {
...
export default withTranslation()(connect(mapStateToProps)(CreateOffers2Router));