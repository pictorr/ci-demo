        ...
        return(
            <Switch>
                ...
                <RegularRoute
                    ...
                    loggedIn
                    path={ '/private/sessions/session/edit/:id/offers/edit-offer/:offerId/generated-offers/:offerDetailsId/details' }
                />
                <RegularRoute
                    render={(props) => {
                    ...
                    loggedIn
                    path={ '/private/sessions/session/edit/:id/offers/edit-offer/:offerId/generated-offers' }
                />
                <RegularRoute
                    render={(props) => {
