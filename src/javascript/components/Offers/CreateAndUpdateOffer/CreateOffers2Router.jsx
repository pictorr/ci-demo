...
class CreateOffersRouter extends PureComponent {
        ...
        return(
            <Switch>
                ...
                <RegularRoute
                    ...
                    loggedIn
                    path={ '/private/sessions/session/edit/:id/offers/new-offer/:offerId/generated-offers/:offerDetailsId/details' }
                />
                <RegularRoute
                    render={(props) => {
                    ...
                    loggedIn
                    path={ '/private/sessions/session/edit/:id/offers/new-offer/:offerId/generated-offers' }
                />
                <RegularRoute
                    render={(props) => {
...
export default withTranslation()(connect(mapStateToProps)(CreateOffersRouter));